...
GH_API_ENDPOINT = 'https://api.github.com/users/titom73/repos'
GH_API_ENDPOINT_INETSIX = 'https://api.github.com/users/inetsix/repos'
...
if __name__ == '__main__':
    ...
    inetsix_data = get_gh_api(url=GH_API_ENDPOINT_INETSIX)
    inetsix_projects = extract_fields(gh_json=inetsix_data, fields=JSON_FIELDS)
    template_data = dict()
    template_data["titom73"] = projects
    template_data["inetsix"] = inetsix_projects
    ...
    output = template.render(projects=template_data)
